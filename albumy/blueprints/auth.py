...
from flask_login import current_user, login_user, logout_user, login_required, login_fresh, confirm_login
...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash('A confirmation email sent, please check your inbox', 'info')
