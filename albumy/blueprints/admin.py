...
def index():
    ...
    return render_template('admin/index.html', user_count=user_count, locked_user_count=locked_user_count,
                           ...
                           reported_photos_count=reported_photos_count, tag_count=tag_count,
                           comment_count=comment_count, reported_comments_count=reported_comments_count)
